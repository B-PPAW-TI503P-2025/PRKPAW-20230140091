...
function Navbar() { 
 ...
 if (!user) {
  ...
  return (
    <nav className="p-4 bg-gray-900 text-white shadow-lg sticky top-0 z-50"> {/* Warna dasar gelap */}
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        {/* Logo/Nama Aplikasi dengan efek neon indigo */}
        <div className="font-extrabold text-2xl text-indigo-400 tracking-wider">
          SISTEM PRESENSI
        </div>
        <div className="flex space-x-6 items-center">
          
          {/* Menu Navigasi dengan efek hover yang lembut */}
          ...
          {/* Menu Laporan Admin (Warna Kontras) */}
          {user.role === 'admin' && (
          ...
          {/* Tombol Logout (Warna Merah Tegas) */}
          <button
