...
// PERBAIKAN: Ambil secret key dari Environment Variables
...
    // Payload sudah benar: menyertakan id, nama, dan role
    const payload = {
      id: user.id,
      nama: user.nama,
      role: user.role 
...
    const token = jwt.sign(payload, JWT_SECRET, { // Menggunakan JWT_SECRET yang sudah benar
      expiresIn: '1h' 
    });
